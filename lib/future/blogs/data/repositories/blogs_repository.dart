...
abstract class BlogsRepository {
  ...
  Future<Either<Failures, BlogModel>> getDetailsBlog({required int id});
}
...
class BlogsRepositoryImpl implements BlogsRepository {
  ...
  @override
  Future<Either<Failures, BlogModel>> getDetailsBlog({required int id}) async {
    return executeAndCatchError<BlogModel>(() async => await blogsRemoteDataSource.getDetailsBlog(id: id));
  }
}
