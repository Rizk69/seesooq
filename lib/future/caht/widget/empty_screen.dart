  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Center(child: titleText(title, HexColor('#4C0497'), StyleText.h4)),
        const SizedBox(
          height: 10,
        ),
        Center(child: titleText(des1, HexColor('#707070'), StyleText.h5)),
        Center(child: titleText(des2, HexColor('#707070'), StyleText.h5)),
      ],
    );
  }
