...
//                     children: [
//                       HeaderNewChatCard(
//                           img: '', name: 'آدم يوسف', onPressed: () {              context.goNamed(Routes.chatPage);
//                       }),
//                       SizedBox(
...
class ChatMassagePage extends StatefulWidget {
  ...
  @override
  State<ChatMassagePage> createState() => _ChatMassagePageState();
}

class _ChatMassagePageState extends State<ChatMassagePage> {
  ...
  void _handleMessageTap(BuildContext _, types.Message message) async {
    if (message is types.FileMessage) {
      ...
      // Corrected: Use OpenFile.open(localPath) instead of OpenFilex.open(localPath)
