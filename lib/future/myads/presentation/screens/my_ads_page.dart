                ...
                child: BlocBuilder<MyadsBloc, MyadsState>(
                  builder: (context, state) {
                    if(state is MyadsLoading){
                      ...
                      var data=state.advertisementModel.data;
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            titleText('عنوان الإعلان هنا',
                                                Colors.black, StyleText.h5),
                                            Spacer(),
                                            Row(
                                              mainAxisAlignment:
                                        ...
                                        titleText('25,000 EGP',
                                            HexColor('4C0497'), StyleText.h5),
                                        const SizedBox(
                                          height: 8,
                                        ),
                                        Row(
                                          children: [
                                            ...
                                            titleText('عدد المشاهدات',
                                                Colors.grey, StyleText.h6),
                                            const SizedBox(
                                              width: 8,
                                            ),
