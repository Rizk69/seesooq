                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        if (state.reasonDeletionsStatus == ReasonDeletionsStatus.loaded &&
                            ...
                            state.reasonDeletionsModel?.data?.data != null) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Container(
                                ...
                                child: ListTile(
                                  onTap: () {
                                    context.read<ReasonDeletionsCubit>().selectReason(reason.id!);
                                  },
                                  title: Text(
                                  ...
                                  subtitle: Text(
                                    reason.description ?? '', // Safe access
                                    style: TextStyle(color: HexColor('200E32'), fontSize: 12),
                                  ),
                                  leading: Radio(
                                    value: reason.id,
                    ...
                    SizedBox(
                        ...
                        child: CustomButtonWidget(
                          ...
                          onPressed: () {
                            context.read<ReasonDeletionsCubit>().deleteAccount();
                          },
                        ))
                  ],
                ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Center(child: titleText('تم حذف الحساب بنجاح', HexColor('#4C0497'), StyleText.h4)),
        const SizedBox(
          height: 10,
        ),
        Center(child: titleText('قمت بحذف الحساب الخاص بك بنجاح،', HexColor('#707070'), StyleText.h5)),
        Center(child: titleText('...تشرفنا بزيارتك', HexColor('#707070'), StyleText.h5)),
        const Spacer(),
        Padding(
