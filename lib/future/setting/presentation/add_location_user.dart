...
import 'package:opensooq/future/setting/presentation/widget/dropdown_location.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Center(
            child: titleText('your_title_has_been_successfully_added',
                HexColor('#4C0497'), StyleText.h4)),
        const SizedBox(
          height: 10,
        ),
        Center(
        ...
        Center(
            child: titleText('you_can_continue_browsing', HexColor('#707070'),
                StyleText.h5)),
        const Spacer(),
        Padding(
