  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Center(child: titleText('تم تعديل الحساب بنجاح', HexColor('#4C0497'), StyleText.h4)),
        const SizedBox(
          height: 10,
        ),
        Center(child: titleText('قمت بتعديل معلومات الحساب الخاصة بك بنجاح', HexColor('#707070'), StyleText.h5)),
