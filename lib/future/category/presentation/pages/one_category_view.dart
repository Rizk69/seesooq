                            ...
                            showCustomModalBottomSheet(
                              ...
                              builder: (context) {
                                return StatefulBuilder(
                                  ...
                                  return BlocProvider.value(
                                    value: widget.cubit,
                                    child: BlocBuilder<DetailsCategoryCubit,
                                      ...
                                      return Column(
                                          ...
                                          children: [
                                            ...
                                            ...stateCubit.filterData?.attributes
                                                                ...
                                                                children: e
                                                                      ...
                                                                      (childrenItem) {
                                                                        return Row(
                                                                          children: [
                                                                            Checkbox(
                                                                              value: stateCubit.idsFilterSelected[e.id.toString()]?.contains(childrenItem.id.toString()) ?? false,
                                                                              onChanged: (value) {
                                                ...
                                                [],
                                            BlocSelector<
                                                DetailsCategoryCubit,
                                                DetailsCategoryState,
                                                RangeValues>(
                                              selector: (state22) =>
                                                  state22.rangeValues,
                                              builder: (context, rangeValue) =>
                                                  RangeSlider(
                                                values: RangeValues(
                                                  rangeValue.start,
                                                  rangeValue.end,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TranslateText(
                              styleText: StyleText.h5,
                              text: state.advertisementModel?.meta?.total
                                      .toString() ??
                                  '',
                            ),
                            SvgCustomImage(
                ...
                SliverPadding(
                  ...
                  sliver: SliverList.separated(
                    itemBuilder: (context, index) {
                      print(
                          'item.album.toString() ${state.advertisementModel!.data!.length}');
              ...
              if (state.viewData == ViewData.filters) ...[
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TranslateText(
                              styleText: StyleText.h5,
                              text: state.filterAdvertisementModel?.meta?.total
                                      .toString() ??
                                  '',
                            ),
                            SvgCustomImage(
                ...
                SliverPadding(
                  ...
                  sliver: SliverList.separated(
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(15),
                                          child: (item.album != null &&
                                                  item.album!.isNotEmpty)
                                              ? item.album?.first['url'] !=
                                                          null &&
                                                      item.album?.first['url']!
                                                              .split('.')
                                                              .last ==
                    ...
                    itemCount:
                        state.filterAdvertisementModel?.data?.length ?? 0,
                  ),
                ),
              ]
            ],
