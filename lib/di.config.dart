...
import 'package:opensooq/core/network/dio_factory.dart' as _i80;
...
import 'package:opensooq/di.dart' as _i79;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i43.SettingRepository>(
        () => _i43.SettingRepositoryImpl(gh<_i42.SettingRemoteDataSource>()));
    gh.factory<_i44.SettingRepository>(() => _i45.SettingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
    ...
    gh.lazySingleton<_i55.CategoryRepo>(() => _i55.CategoryRepoImpl(
          gh<_i8.NetworkInfo>(),
          gh<_i54.CategoryRemoteDataSource>(),
        ));
    gh.lazySingleton<_i56.CategoryRepository>(
        () => _i56.CategoryRepositoryImpl(gh<_i53.CategoryRemoteDataSource>()));
    ...
    gh.lazySingleton<_i62.GetFingerPrintUseCase>(() =>
        _i62.GetFingerPrintUseCase(
            settingRepository: gh<_i44.SettingRepository>()));
    ...
    gh.factory<_i76.CategoryCubit>(
        () => _i76.CategoryCubit(categoryRepo: gh<_i55.CategoryRepo>()));
    gh.factory<_i77.CategoryProductCubit>(
        () => _i77.CategoryProductCubit(categoryRepo: gh<_i55.CategoryRepo>()));
    gh.lazySingleton<_i78.SignUpCubit>(
        () => _i78.SignUpCubit(gh<_i75.SignUpRepository>()));
    return this;
  }
}
...
class _$DioFactory extends _i80.DioFactory {}
