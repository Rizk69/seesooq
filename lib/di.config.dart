...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i76.FilterUseCase>(
        () => _i76.FilterUseCase(gh<_i69.CategoryRepo>()));
    gh.lazySingleton<_i77.ForGetPasswordUserUseCase>(() =>
        _i77.ForGetPasswordUserUseCase(
            loginRepository: gh<_i33.LoginRepository>()));
    gh.lazySingleton<_i78.GetPackagesUseCase>(() => _i78.GetPackagesUseCase(
        packagesRepository: gh<_i44.PackagesRepository>()));
    gh.lazySingleton<_i79.GetSavedLangUseCase>(() =>
        _i79.GetSavedLangUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i80.GetThemeUseCase>(() =>
        _i80.GetThemeUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i81.GetUserLocalUseCase>(() =>
        _i81.GetUserLocalUseCase(loginRepository: gh<_i33.LoginRepository>()));
    ...
    gh.lazySingleton<_i83.GetWalletUseCase>(() =>
        _i83.GetWalletUseCase(walletRepository: gh<_i60.WalletRepository>()));
    ...
    gh.factory<_i86.NotificationCubit>(() => _i86.NotificationCubit(
        getUserNotificationsUseCase: gh<_i82.GetUserNotificationsUseCase>()));
    gh.lazySingleton<_i87.SignUpRemoteDataSource>(
        () => _i87.SignUpRemoteDataSourceImpl(
              gh<_i10.CacheHelper>(),
              gh<_i56.SignupApi>(),
            ));
    gh.lazySingleton<_i88.SignUpRepository>(
        () => _i88.SignUpRepositoryImpl(gh<_i87.SignUpRemoteDataSource>()));
    gh.lazySingleton<_i89.StorePaymentWalletUseCase>(() =>
        _i89.StorePaymentWalletUseCase(
            walletRepository: gh<_i60.WalletRepository>()));
    gh.factory<_i90.CategoryCubit>(
        () => _i90.CategoryCubit(categoryRepo: gh<_i69.CategoryRepo>()));
    gh.factory<_i91.CategoryProductCubit>(
        () => _i91.CategoryProductCubit(categoryRepo: gh<_i69.CategoryRepo>()));
    gh.lazySingleton<_i92.SignUpCubit>(
        () => _i92.SignUpCubit(gh<_i88.SignUpRepository>()));
    return this;
  }
}
