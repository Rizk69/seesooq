...
import 'package:opensooq/core/network/api/blogs_api.dart' as _i64;
import 'package:opensooq/core/network/api/category_api.dart' as _i67;
...
import 'package:opensooq/core/network/api/signup_api.dart' as _i57;
import 'package:opensooq/core/network/api/wallet_api.dart' as _i59;
...
import 'package:opensooq/future/category/data/repositories/category_repository.dart'
    as _i71;
import 'package:opensooq/future/category/domain/filter_usecase.dart' as _i79;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i47.PaymentRemoteDataSource>(
        () => _i47.PaymentRemoteDataSourceImpl(gh<_i46.PaymentApi>()));
    gh.lazySingleton<_i48.PaymentRemoteDataSource>(
        () => _i48.PaymentRemoteDataSourceImpl(gh<_i10.CacheHelper>()));
    gh.lazySingleton<_i49.PaymentRepository>(
        () => _i49.PaymentRepositoryImpl(gh<_i47.PaymentRemoteDataSource>()));
    ...
    gh.lazySingleton<_i54.SettingLocalDataSource>(
        () => _i54.SettingLocalDataSourceImpl(gh<_i10.CacheHelper>()));
    gh.lazySingleton<_i55.SettingRemoteDataSource>(
        () => _i55.SettingRemoteDataSourceImpl(gh<_i53.SettingApi>()));
    gh.lazySingleton<_i56.SettingRepository>(
        () => _i56.SettingRepositoryImpl(gh<_i55.SettingRemoteDataSource>()));
    gh.factory<_i57.SignupApi>(() => _i57.SignupApi(gh<_i5.Dio>()));
    gh.lazySingleton<_i58.VerifyForGetPasswordUserUseCase>(() =>
        _i58.VerifyForGetPasswordUserUseCase(
            loginRepository: gh<_i33.LoginRepository>()));
    gh.factory<_i59.WalletApi>(() => _i59.WalletApi(gh<_i5.Dio>()));
    gh.lazySingleton<_i60.WalletRemoteDataSource>(
        () => _i60.WalletRemoteDataSourceImpl(walletApi: gh<_i59.WalletApi>()));
    gh.lazySingleton<_i61.WalletRepository>(() => _i62.WalletRepositoryImpl(
        walletRemoteDataSource: gh<_i60.WalletRemoteDataSource>()));
    gh.lazySingleton<_i63.AddFavUseCase>(
        () => _i63.AddFavUseCase(gh<_i14.FavRepository>()));
    gh.factory<_i64.BlogsApi>(() => _i64.BlogsApi(gh<_i5.Dio>()));
    gh.lazySingleton<_i65.BlogsRemoteDataSource>(
        () => _i65.BlogsRemoteDataSourceImpl(gh<_i64.BlogsApi>()));
    gh.lazySingleton<_i66.BlogsRepository>(
        () => _i66.BlogsRepositoryImpl(gh<_i65.BlogsRemoteDataSource>()));
    gh.factory<_i67.CategoryApi>(() => _i67.CategoryApi(gh<_i5.Dio>()));
    gh.lazySingleton<_i68.CategoryRemoteDataSource>(
        () => _i68.CategoryRemoteDataSourceImpl(gh<_i67.CategoryApi>()));
    gh.lazySingleton<_i69.CategoryRemoteDataSource>(
        () => _i69.CategoryRemoteDataSourceImpl(gh<_i67.CategoryApi>()));
    gh.lazySingleton<_i70.CategoryRepo>(() => _i70.CategoryRepoImpl(
          gh<_i8.NetworkInfo>(),
          gh<_i69.CategoryRemoteDataSource>(),
        ));
    gh.lazySingleton<_i71.CategoryRepository>(
        () => _i71.CategoryRepositoryImpl(gh<_i68.CategoryRemoteDataSource>()));
    gh.lazySingleton<_i72.ChangeLangUseCase>(() =>
        _i72.ChangeLangUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i73.ChangePasswordUserUseCase>(() =>
        _i73.ChangePasswordUserUseCase(
            loginRepository: gh<_i33.LoginRepository>()));
    gh.lazySingleton<_i74.ChangeThemeUseCase>(() =>
        _i74.ChangeThemeUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i75.DeleteFavReelUseCase>(
        () => _i75.DeleteFavReelUseCase(gh<_i14.FavRepository>()));
    ...
    gh.lazySingleton<_i77.DetailsCategoryCubit>(() => _i77.DetailsCategoryCubit(
        categoryRepository: gh<_i71.CategoryRepository>()));
    gh.lazySingleton<_i78.FavReelsUseCase>(
        () => _i78.FavReelsUseCase(gh<_i14.FavRepository>()));
    gh.lazySingleton<_i79.FilterUseCase>(
        () => _i79.FilterUseCase(gh<_i70.CategoryRepo>()));
    gh.lazySingleton<_i80.ForGetPasswordUserUseCase>(() =>
        _i80.ForGetPasswordUserUseCase(
            loginRepository: gh<_i33.LoginRepository>()));
    ...
    gh.lazySingleton<_i82.GetSavedLangUseCase>(() =>
        _i82.GetSavedLangUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i83.GetThemeUseCase>(() =>
        _i83.GetThemeUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i84.GetUserLocalUseCase>(() =>
        _i84.GetUserLocalUseCase(loginRepository: gh<_i33.LoginRepository>()));
    ...
    gh.lazySingleton<_i86.GetWalletUseCase>(() =>
        _i86.GetWalletUseCase(walletRepository: gh<_i61.WalletRepository>()));
    gh.factory<_i87.LocaleCubit>(() => _i87.LocaleCubit(
          getSavedLangUseCase: gh<_i82.GetSavedLangUseCase>(),
          changeLangUseCase: gh<_i72.ChangeLangUseCase>(),
          changeThemeUseCase: gh<_i74.ChangeThemeUseCase>(),
          getThemeUseCase: gh<_i83.GetThemeUseCase>(),
        ));
    gh.lazySingleton<_i88.LoginCubit>(() => _i88.LoginCubit(
          gh<_i33.LoginRepository>(),
          gh<_i80.ForGetPasswordUserUseCase>(),
          gh<_i73.ChangePasswordUserUseCase>(),
        ));
    gh.factory<_i89.NotificationCubit>(() => _i89.NotificationCubit(
        getUserNotificationsUseCase: gh<_i85.GetUserNotificationsUseCase>()));
    gh.lazySingleton<_i90.SignUpRemoteDataSource>(
        () => _i90.SignUpRemoteDataSourceImpl(
              gh<_i10.CacheHelper>(),
              gh<_i57.SignupApi>(),
            ));
    gh.lazySingleton<_i91.SignUpRepository>(
        () => _i91.SignUpRepositoryImpl(gh<_i90.SignUpRemoteDataSource>()));
    gh.lazySingleton<_i92.StorePaymentWalletUseCase>(() =>
        _i92.StorePaymentWalletUseCase(
            walletRepository: gh<_i61.WalletRepository>()));
    gh.factory<_i93.CategoryCubit>(
        () => _i93.CategoryCubit(categoryRepo: gh<_i70.CategoryRepo>()));
    gh.factory<_i94.CategoryProductCubit>(
        () => _i94.CategoryProductCubit(categoryRepo: gh<_i70.CategoryRepo>()));
    gh.lazySingleton<_i95.SignUpCubit>(
        () => _i95.SignUpCubit(gh<_i91.SignUpRepository>()));
    return this;
  }
}
