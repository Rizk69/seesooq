...
import 'package:opensooq/core/network/dio_factory.dart' as _i95;
...
import 'package:opensooq/di.dart' as _i94;
...
import 'package:opensooq/future/category/data/repositories/category_repository.dart'
    as _i70;
import 'package:opensooq/future/category/domain/filter_usecase.dart' as _i77;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i70.CategoryRepository>(
        () => _i70.CategoryRepositoryImpl(gh<_i68.CategoryRemoteDataSource>()));
    ...
    gh.lazySingleton<_i74.DeleteFavUseCase>(
        () => _i74.DeleteFavUseCase(gh<_i14.FavRepository>()));
    gh.lazySingleton<_i75.DetailsCategoryCubit>(() => _i75.DetailsCategoryCubit(
        categoryRepository: gh<_i70.CategoryRepository>()));
    gh.lazySingleton<_i76.FavReelsUseCase>(
        () => _i76.FavReelsUseCase(gh<_i14.FavRepository>()));
    gh.lazySingleton<_i77.FilterUseCase>(
        () => _i77.FilterUseCase(gh<_i69.CategoryRepo>()));
    gh.lazySingleton<_i78.ForGetPasswordUserUseCase>(() =>
        _i78.ForGetPasswordUserUseCase(
            loginRepository: gh<_i33.LoginRepository>()));
    gh.lazySingleton<_i79.GetPackagesUseCase>(() => _i79.GetPackagesUseCase(
        packagesRepository: gh<_i44.PackagesRepository>()));
    gh.lazySingleton<_i80.GetSavedLangUseCase>(() =>
        _i80.GetSavedLangUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i81.GetThemeUseCase>(() =>
        _i81.GetThemeUseCase(langRepository: gh<_i25.LocaleRepository>()));
    gh.lazySingleton<_i82.GetUserLocalUseCase>(() =>
        _i82.GetUserLocalUseCase(loginRepository: gh<_i33.LoginRepository>()));
    gh.factory<_i83.GetUserNotificationsUseCase>(() =>
        _i83.GetUserNotificationsUseCase(
            notificationRepository: gh<_i40.NotificationRepository>()));
    gh.lazySingleton<_i84.GetWalletUseCase>(() =>
        _i84.GetWalletUseCase(walletRepository: gh<_i60.WalletRepository>()));
    gh.factory<_i85.LocaleCubit>(() => _i85.LocaleCubit(
          getSavedLangUseCase: gh<_i80.GetSavedLangUseCase>(),
          changeLangUseCase: gh<_i71.ChangeLangUseCase>(),
          changeThemeUseCase: gh<_i73.ChangeThemeUseCase>(),
          getThemeUseCase: gh<_i81.GetThemeUseCase>(),
        ));
    gh.lazySingleton<_i86.LoginCubit>(() => _i86.LoginCubit(
          gh<_i33.LoginRepository>(),
          gh<_i78.ForGetPasswordUserUseCase>(),
          gh<_i72.ChangePasswordUserUseCase>(),
        ));
    gh.factory<_i87.NotificationCubit>(() => _i87.NotificationCubit(
        getUserNotificationsUseCase: gh<_i83.GetUserNotificationsUseCase>()));
    gh.lazySingleton<_i88.SignUpRemoteDataSource>(
        () => _i88.SignUpRemoteDataSourceImpl(
              gh<_i10.CacheHelper>(),
              gh<_i56.SignupApi>(),
            ));
    gh.lazySingleton<_i89.SignUpRepository>(
        () => _i89.SignUpRepositoryImpl(gh<_i88.SignUpRemoteDataSource>()));
    gh.lazySingleton<_i90.StorePaymentWalletUseCase>(() =>
        _i90.StorePaymentWalletUseCase(
            walletRepository: gh<_i60.WalletRepository>()));
    gh.factory<_i91.CategoryCubit>(
        () => _i91.CategoryCubit(categoryRepo: gh<_i69.CategoryRepo>()));
    gh.factory<_i92.CategoryProductCubit>(
        () => _i92.CategoryProductCubit(categoryRepo: gh<_i69.CategoryRepo>()));
    gh.lazySingleton<_i93.SignUpCubit>(
        () => _i93.SignUpCubit(gh<_i89.SignUpRepository>()));
    return this;
  }
}

class _$RegisterModule extends _i94.RegisterModule {}

class _$DioFactory extends _i95.DioFactory {}
