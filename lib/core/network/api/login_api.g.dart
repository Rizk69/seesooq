...
class _LoginApi implements LoginApi {
  ...
  Future<LoginModel> loginUser({required Map<String, dynamic> body}) async {
    ...
    final value = await compute(deserializeLoginModel, _result.data!);
    return value;
  }
  ...
  Future<ForGetPasswordModel> forGetPassword(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ForGetPasswordModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = await compute(deserializeForGetPasswordModel, _result.data!);
    return value;
  }
  ...
  Future<ChangePasswordModel> changePasswordUser(
    ...
    final value = await compute(deserializeChangePasswordModel, _result.data!);
    return value;
  }
