...
class _HomeUserApi implements HomeUserApi {
  _HomeUserApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<SingleAdvertismentModel> showAdvertisment({required int id}) async {
    ...
    final value =
        await compute(deserializeSingleAdvertismentModel, _result.data!);
    return value;
  }
  ...
  Future<MyStoryModel> getMyStories() async {
    ...
    final value = await compute(deserializeMyStoryModel, _result.data!);
    return value;
  }
  ...
  Future<UsersStoryModel> getUsersStory() async {
    ...
    final value = await compute(deserializeUsersStoryModel, _result.data!);
    return value;
  }

  @override
  Future<AdvertisementModel> getOfferAds({
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'advertisement/offers/${categoryId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<BannersModel> getBanners({required int page}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    final value = await compute(deserializeBannersModel, _result.data!);
    return value;
  }
