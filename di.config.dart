...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i37.SettingRepository>(
        () => _i37.SettingRepositoryImpl(gh<_i36.SettingRemoteDataSource>()));
    gh.factory<_i38.SettingRepository>(() => _i39.SettingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
    ...
    gh.lazySingleton<_i49.CategoryRepo>(() => _i49.CategoryRepoImpl(
          gh<_i8.NetworkInfo>(),
          gh<_i47.CategoryRemoteDataSource>(),
        ));
    gh.lazySingleton<_i50.CategoryRepository>(
        () => _i50.CategoryRepositoryImpl(gh<_i48.CategoryRemoteDataSource>()));
    ...
    gh.lazySingleton<_i56.GetFingerPrintUseCase>(() =>
        _i56.GetFingerPrintUseCase(
            settingRepository: gh<_i38.SettingRepository>()));
